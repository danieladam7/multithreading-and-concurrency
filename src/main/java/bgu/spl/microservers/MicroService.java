...
public abstract class MicroService implements Runnable {
    ...
    private final ConcurrentHashMap<Class<?>,Callback> messageCallbackHashMap= new ConcurrentHashMap<>();
    ...
    protected final void sendBroadcast(Broadcast b) {
        if(name.equals("ICML"))
            System.out.println("ICML is sending a broadcast");
    ...
    /**
     * Signals the event loop that it must terminateCPU after handling the current
     * message.
     */
    protected final void terminate() {
        if(name.equals("ICML"))
            System.out.println("ICML is terminating");
    ...
    public final void run() {
        ...
        while (!terminated) {
            ...
            if(message!=null){
                messageCallbackHashMap.get(message.getClass()).call(message);
            }
        }
